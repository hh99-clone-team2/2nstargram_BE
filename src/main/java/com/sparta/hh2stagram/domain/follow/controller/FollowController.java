...
public class FollowController {
    ...
    public ResponseEntity<?> follow(@PathVariable Long userId, @AuthenticationPrincipal UserDetails userDetails) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ResponseDto.success("팔로우 되었습니다.", null));
    }
    ...
    public ResponseEntity<?> unfollow(@PathVariable Long userId, @AuthenticationPrincipal UserDetails userDetails) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ResponseDto.success("언팔로우 되었습니다.", null));
    }
    ...
    public ResponseEntity<?> getFollowingList(@PathVariable Long userId) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ResponseDto.success("팔로잉 목록 조회 성공", followingList));
    }
    ...
    public ResponseEntity<?> getFollowerList(@PathVariable Long userId) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(ResponseDto.success("팔로워 목록 조회 성공", followerList));
    }
}